...
public class Board
{
    ...
    public ulong[] pieceBitboards = new ulong[13];     // main bitboards
    public ulong whitePieces;
    public ulong blackPieces;
    public ulong allPieces;
    
    public ulong[] knightAttacks = new ulong[64];
    public ulong[] kingAttacks = new ulong[64];

    public ulong[] rookMasks = new ulong[64];
    public ulong[] rookBlockersMasks = new ulong[64];
